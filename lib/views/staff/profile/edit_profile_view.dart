        ...
        children: [
              ...
              children: [
                CircleAvatar(
                  ...
                  backgroundImage: selectedImage.value != null
                      ? MemoryImage(selectedImage.value!)
          ...
          Expanded(
            child: Padding(
              ...
              child: Column(
                children: [
                  buildField("الاسم الأول", "أدخل الاسم الأول", firstNameController),
                  buildField("اسم العائلة", "أدخل اسم العائلة", lastNameController),
                  buildField("البريد الإلكتروني", "example@mail.com", emailController,
                      keyboardType: TextInputType.emailAddress),
                  buildField("رقم الهاتف", "+966xxxxxxxxx", phoneController,
          ...
          TextField(
            ...
            onChanged: (value) {
              ...
              if (label.contains("الاسم")) {
                controller.text = value.replaceAll(RegExp(r'[^a-zA-Zأ-ي ]'), '');
